/**
 * CONFIGURATION CENTRALE DU CABINET D'AVOCATS
 * -------------------------------------------------------------
 * Ce fichier permet de personnaliser l'intégralité du site vitrine
 * en quelques minutes pour n'importe quel cabinet d'avocats au Sénégal.
 * 
 * Il suffit de modifier les valeurs ci-dessous pour adapter :
 * - Le nom du cabinet, le logo et les slogans
 * - Les coordonnées (adresse à Dakar, téléphone, email, WhatsApp)
 * - Les chiffres clés et statistiques
 * - Les domaines d'expertise et leurs contenus
 * - La liste des avocats et du personnel administratif
 */
...
const CABINET_CONFIG = {
  ...
  identity: {
    ...
    headline: "Votre défense. Notre engagement.",
    subheadline: "Un cabinet d'avocats d'affaires et de contentieux engagé aux côtés des entreprises, institutions et particuliers pour apporter des solutions juridiques rigoureuses, stratégiques et adaptées à chaque situation au Sénégal et dans l'espace OHADA.",
    foundedYear: 2008,
    barreau: "Ordre des Avocats du Sénégal (Barreau de Dakar)",
    juridiction: "Cour d'Appel de Dakar & Cour Commune de Justice et d'Arbitrage (CCJA)",
    logoBadge: "DA",
  ...
  contact: {
    ...
    hours: {
      ...
      sunday: "Dimanche : Fermé (Permanence pénale 24h/7j)"
    }
  },

  // Réseaux Sociaux & Liens Institutionnels
  social: {
  ...
  // Statistiques et Chiffres Clés (facilement modifiables)
  stats: [
    {
      value: "18+",
  ...
  // Valeurs Fondamentales du Cabinet
  values: [
    {
      id: "expertise",
      title: "Excellence & Rigueur",
      subtitle: "Une maîtrise approfondie du droit sénégalais et OHADA",
      description: "Chaque dossier fait l'objet d'une analyse doctrinale et jurisprudentielle minutieuse pour forger des stratégies sur-mesure d'une haute précision juridique.",
      icon: "balance"
    },
    {
      id: "engagement",
      title: "Engagement & Combativité",
      subtitle: "Une implication constante aux côtés de nos mandants",
      description: "Nous défendons vos intérêts avec détermination, disponibilité immédiate et une recherche perpétuelle de l'efficacité économique et procédurale.",
      icon: "shield"
    },
    {
      id: "confidentialite",
      title: "Confidentialité Absolue",
      subtitle: "Le secret professionnel au cœur de notre déontologie",
      description: "Respect strict des règles déontologiques du Barreau de Dakar, sécurisation des échanges et discrétion totale pour tous nos clients.",
      icon: "lock"
    }
  ],
  ...
  expertise: [
    ...
    },
    {
      ...
      shortDesc: "Conseil et contentieux sous l'égide du Traité OHADA. Représentation devant les juridictions nationales sénégalaises et la Cour Commune de Justice et d'Arbitrage (CCJA d'Abidjan).",
      scope: [
    ...
    lawyers: [
      {
        ...
        photo: "assets/images/partner_diallo.jpg",
      ...
      },
      {
        ...
        photo: "assets/images/associate_fall.jpg",
      ...
      },
      {
        ...
        photo: "assets/images/associate_tall.jpg",
    ...
    administrative: [
      {
        ...
        photo: "assets/images/admin_director.jpg",
...
// Export pour utilisation navigateur ou modulaire
